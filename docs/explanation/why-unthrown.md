...
> **Explanation.** This page is about _understanding_ — why the library exists
> and what problem it solves. If you'd rather get your hands on the code first,
> start with the [Getting Started tutorial](../tutorial/getting-started).
...
Two more deliberate choices follow from it:
...
carried forward. The [`@unthrown/oxlint`](../how-to/lint-your-codebase) rule
...
- **neverthrow / boxed / byethrow** — model errors as values, but have no proper
  ...
  omits (see [Design decisions](./design-decisions)).
...
- Build something: [Getting Started](../tutorial/getting-started).
- Understand the core idea: [The Defect Channel](./the-defect-channel).
- See how it stacks up: [Comparison](./comparison).
