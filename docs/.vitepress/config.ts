...
const GUIDE_SIDEBAR = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Observe and log failures", link: "/how-to/observe-failures" },
      { text: "Handle results at the edge", link: "/how-to/handle-results-at-the-edge" },
      { text: "Recipes: retry, timeout, concurrency", link: "/how-to/recipes" },
...
const API_SIDEBAR = [
  {
    ...
    items: [
      ...
      { text: "@unthrown/saga", link: "/api/saga/" },
...
export default defineConfig({
  ...
  // No `ignoreDeadLinks`: the guide and the TypeDoc output under /api/ both
  // link-check clean, so any dead link fails the build.
    ...
    nav: [
      ...
      // the entry page of each. See the sidebar for the full contents.
      {
        ...
        items: [
          ...
          // Keep this pointed at the first how-to sidebar entry.
