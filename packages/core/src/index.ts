...
// helpers (`P.tag`, `P.instanceOf`, `P.when`, plus the wildcard escape hatch
// `P._` — name your cases instead wherever `E` is concrete), and
// `NonExhaustiveError` is what a rogue unmatched value throws at the `match`
// edge.
